...
from tgchannel_push.api.routes import (
    channels_router,
    creatives_router,
    groups_router,
    health_router,
...
from tgchannel_push.bot.bot import dp, setup_handlers, reinit_bot
from tgchannel_push.config import get_settings
from tgchannel_push.database import init_db
from tgchannel_push.scheduler.scheduler import start_scheduler, stop_scheduler, sync_slot_jobs
...
async def lifespan(app: FastAPI):
    ...
    # Startup
    logger.info(f"Starting TGChannel-Push v{__version__}")
...
if _web_dist_dir.exists():
    ...
    async def no_frontend():
        ...
        return {
            "message": "TGChannel-Push API Server",
            "version": __version__,
            "docs": "/docs",
